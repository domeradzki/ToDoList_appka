...
const getTasksFromLocalStorage = () => {
    ...
    if (savedTasks) {
        ...
        // Update each task to include the isCompleted status from localStorage
...
// Akktualizacja statusu zadania aby działało po odświeżeniu
...
const navigation = [
    ...
    { name: 'Raporty', href: '#', current: false },
]
            ...
            <div className="min-h-full">
                ...
                <main>
                    <div className="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
                        ...
                        <Tasks tasks={tasks} onDeleteTask={onDeleteTask} onUpdateTaskStatus={updateTaskStatus} />
                    </div>
                </main>
            </div>
        </>
